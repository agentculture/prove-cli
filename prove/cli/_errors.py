...
Every failure inside prove-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`prove.cli._output`,
...
# Exit-code policy. Documented in ``prove-cli learn`` output.
# 0      = success
