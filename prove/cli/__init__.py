...
from prove.cli._errors import EXIT_USER_ERROR, CliError
from prove.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/prove-cli/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    from prove.cli._commands import cli as _cli_group
    from prove.cli._commands import doctor as _doctor_cmd
    from prove.cli._commands import explain as _explain_cmd
    from prove.cli._commands import learn as _learn_cmd
    from prove.cli._commands import overview as _overview_cmd
    from prove.cli._commands import whoami as _whoami_cmd

    parser = _CliArgumentParser(
        prog="prove-cli",
        description="prove-cli — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
    ...
    #   from prove.cli._commands import my_noun as _my_noun_group
